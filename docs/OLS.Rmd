...
Si tenemos una muestra grande y los supuestos anteriores se cumplen, usando el teorema del limite central, la distribución asintótica del estimador es dada por,
    \begin{equation}
