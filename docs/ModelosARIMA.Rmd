...
Es importante recalcar que, cuando se menciona el x_t de cualquier periodo, siempre a cada componente de la ecuación de x_t se le va a restar el numero de los rezagos lo cual hace refrencia a iterar hacia atras.
#
