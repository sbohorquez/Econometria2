...
\begin{align}
\gamma_1 & = \phi \gamma_0 + E[\varepsilon_t  x_{t-1}]  - \theta E[\varepsilon_{t-1} x_{t-1}] \\
...
Sea $MV$ la máxima verosimilitud, $T$ el número de observaciones y $k$ el número de parámetros. Entonces
...
**Advertencia:** La máxima verosimilitud $MV$ depende de los supuestos sobre el error, por lo tanto, una vez escogido el modelo se deben validar los supuestos sobre el error.x
