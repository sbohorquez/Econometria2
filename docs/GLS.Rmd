...
<li> Estimamos el siguiente modelo de regresión,
        \begin{equation}
...
En la literatura de series de tiempo, los errores estándares robustos a correlación serial son a veces llamados, HAC, por sus siglas en inglés (heteroskedasticity and autocorrelation consistent)
